const queryUser = {
    ...
    createUser: 'EXECUTE sp_create_user @nombres= :nombres, @docu= :docu, @age= :age, @height= :height, @telefono= :tel, @pass= :pas, @rol= :rol, @estado= :estado',
    updateUser: 'EXECUTE sp_update_user @id= :id, @nombres= :nombres, @docu= :docu, @age= :age, @height= :height, @telefono= :tel, @pass= :pas, @rol= :rol, @estado= :estado',
